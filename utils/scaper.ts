...
const drama_search_base_url =
    "https://www2.dramacool.sk/search?type=movies&keyword=";
    ...
    */
    try {
        ...
        const request = await axios.get(
            `${drama_detail_base_url}${dramaTitle}`
        );
        ...
        // other title
        const other_name_soup = htmlSoup("p[class=other_name]")
            .children("a")
            .toArray();
        ...
        // genre
        const genre_tags = htmlSoup('span:contains("Genre:")')
            .parent()
            .find("a")
            .toArray();
